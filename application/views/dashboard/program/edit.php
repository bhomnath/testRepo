...
<?php if(!empty($program)){
    foreach($program as $progData){
        $id = $progData->id;
        $name = $progData->name;
        $fullName = $progData->fullName;
        $facultyId = $progData->facultyId;
    }
    ?>
                            ...
                            <div class="col-lg-12">
                            <?php echo form_open_multipart('program/updateProgram', array('id' => 'inline-validate', 'class' => 'form-horizontal', 'novalidate' => 'novalidate')); ?>
 ...
 <?php if(!empty($faculty)){ ?>
                            ...
                            <div class="col-lg-6">
                                ...
                                <?php foreach($faculty as $faculties){ ?>
                                    <option value="<?php echo $faculties->id; ?>" <?php if($facultyId == $faculties->id){ echo "selected"; } ?> > <?php echo $faculties->name; ?> </option>
                                <?php } ?>
                                </select>
                           ...
                           <?php } ?>
                            ...
                            <div class="col-lg-6">
                                <input type="text" class="form-control col-lg-12" name="programNameShort" id="programNameShort" value="<?php echo $name; ?>" required >
                            ...
                            <div class="col-lg-6">
                                <input type="text" class="form-control col-lg-12" name="programNameFull" id="programNameFull" value="<?php echo $fullName; ?>" required >
                            <?php echo form_error('programNameFull'); ?>
                             ...
                             <div class="col-lg-12">
                            <button class="" type="submit">Update Program</button>
                            </div>
                        <?php echo form_close(); ?>  
