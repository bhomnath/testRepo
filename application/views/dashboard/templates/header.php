...
<html lang="en">
  <head>
    ...
    <title>Dashboard - PU Syllabus - Bihani Tech</title>
    <!-- Bootstrap core CSS -->
  ...
  <section id="container" >
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <header class="header black-bg">
            ...
            <!--logo start-->
            <a href="<?php echo base_url(); ?>" class="logo"><b>PU SYLLABUS</b></a>
            <!--logo end-->
...
<!--                    <li id="header_inbox_bar" class="dropdown">
            ...
            <div class="top-menu">
            	<ul class="nav pull-right top-menu">
                  <li class="dropdown">
                        <a class="dropdown-toggle logout" data-toggle="dropdown" href="#">
                            <i class="icon-user "></i>&nbsp; <?php echo $this->session->userdata('email'); ?> &nbsp; <i class="icon-chevron-down "></i>
                        </a>

                        <ul class="dropdown-menu dropdown-user">
                            <li><a href="<?php echo base_url().'user/profile' ?>"><i class="icon-user"></i> User Profile </a>
                            </li>
                            
                            <li class="divider"></li>
                            <li><a href="<?php echo base_url().'login/logout' ?>"><i class="icon-signout"></i> Logout </a>
                            </li>
                        </ul>
