    ...
    foreach ($faculty as $faculties) {
        ...
        ?>
                                        <tr>
                                            ...
                                            <td><?php echo $faculties->name; ?></td>
                                            <td><a href="<?php echo base_url().'faculty/edit/'.$faculties->id; ?>">Edit</a> / <a href="<?php echo base_url().'faculty/delete/'.$faculties->id; ?>">Delete</a></td>
