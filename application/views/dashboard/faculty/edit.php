...
<?php if(!empty($faculty)){
    ...
    ?>
                            ...
                            <div class="col-lg-12">
                            <?php echo form_open_multipart('faculty/updateFaculty', array('id' => 'inline-validate', 'class' => 'form-horizontal', 'novalidate' => 'novalidate')); ?>
                                <input type="hidden" name="facultyId" value="<?php echo $id; ?>" />
                            <div class="col-lg-8">
                                <div class="form-group">
                            <label class="control-label col-lg-2">Faculty Name</label>

                            <div class="col-lg-6">
                                <input type="text" class="form-control col-lg-12" name="facultyName" id="facultyName" value="<?php echo $name; ?>" required >
                            <?php echo form_error('facultyName'); ?>
                            </div>
                        </div>
                            </div>
                             <div class="col-lg-12">
                            <button class="" type="submit">Update Faculty</button>
                            </div>
                        <?php echo form_close(); ?>  
